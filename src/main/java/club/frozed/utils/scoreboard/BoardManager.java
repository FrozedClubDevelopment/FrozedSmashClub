package club.frozed.utils.scoreboard;
...
public class BoardManager {
	...
	public BoardManager(BoardAdapter adapter, int updateTick) {
		...
		Bukkit.getPluginManager().registerEvents(new BoardListener(this), FrozedSmashClub.getInstance());
		Bukkit.getScheduler().runTaskTimer(FrozedSmashClub.getInstance(), this::sendScoreboard, 0, updateTick);
	}
